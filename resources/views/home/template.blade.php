        ...
        <div class="row justify-content-evenly">
            ...
            <div class="col-md-5" id="kontak">
                <div class="m-4 text-center">
	                ...
	                <a href="mailto:siska@example.com" class="d-block border rounded-pill text-white p-3 m-2 text-decoration-none"><i class="fas fa-envelope"></i> siska@example.com</a>
                </div>
            </div>
        </div>
        <div class="row">
