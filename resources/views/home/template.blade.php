        ...
        <div class="row">
            <div class="col-8 d-flex justify-content-center m-auto">
                ...
                <div class="m-4 text-center" id="kontak">
                    ...
                    <a href="mailto:siska.contact@gmail.com" class="contact"><i class="fas fa-envelope"></i> siska.contact@gmail.com</a>
                </div>
            </div>
            <div class="col-8 d-flex justify-content-center m-auto">
                <div class="m-4 text-center">
                    <h2 class="mb-3 text-white">Alamat</h2>
                    <a href="https://www.google.com/maps/place/SMK+Negeri+1+Purwokerto/@-7.421002,109.2543996,17.11z/data=!4m5!3m4!1s0x2e655e96a7e3cc79:0x6d79bcd9709b4b6!8m2!3d-7.4216156!4d109.2544097" class="text-white">Jl. DR. Soeparno No.29, Purwokerto Wetan, Kec. Purwokerto Tim., Kabupaten Banyumas, Jawa Tengah 53123</a>
                    <h4 class="text-white mt-2">SMK NEGERI 1 PURWOKERTO</h4>
                </div>
            </div>
        </div>
    </div>
