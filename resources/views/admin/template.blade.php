      ...
      <div class="row">
        <div class="col-md-2 pt-4 ps-0 bg-dark menu-bar" style="height: 100vh">
          <div class="list-group bg-dark">
            ...
            <a class="nav-link text-white" href="/admin?desa={{ $desa->id }}"><i class="fas fa-home fa-fw me-1"></i> Home</a>
            <a class="nav-link text-white" href="/admin/identitas_desa?desa={{ $desa->id }}"><i class="fas fa-info fa-fw me-1"></i> Info Desa</a>
            ...
            <a class="nav-link text-white" href="#"><i class="fas fa-book-reader fa-fw me-1"></i> Layanan Surat</a>
            <div class="dropdown hihi">
              <button class="btn menu dropdown-toggle text-white" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <a class="nav-link text-white" href="/admin/program-bantuan?desa={{ $desa->id }}"><i class="fas fa-coins fa-fw me-1"></i> Program Bantuan</a>
            <a class="nav-link text-white" href="#"><i class="fas fa-globe-asia fa-fw me-1"></i> Pemetaaan</a>
            <a class="nav-link text-white" href="#"><i class="far fa-envelope fa-fw me-1"></i> SMS</a>
            <a class="nav-link text-white" href="#"><i class="fas fa-cog fa-fw me-1"></i> Pengaturan</a>
          </div>
        </div>
