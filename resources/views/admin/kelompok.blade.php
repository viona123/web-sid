...
<button onclick="location.reload();" class="btn btn-warning m-2"><i class="fas fa-sync d-inline-block me-2"></i> Bersihkan</button>
...
<div class="modal fade" id="tambah-data" tabindex="-1" aria-labelledby="tambah-data-label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/admin/kelompok/tambah?desa={{ $desa->id }}" method="post">
      @csrf
